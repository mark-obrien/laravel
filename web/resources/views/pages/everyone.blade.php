...
<div id="main">
    <div class="page-header">
        <h1>Clients <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#create-user-modal">Add <i class="fa fa-plus"></i></a></h1>
    </div>
        ...
        <table class="table">
            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    <td><a href="account.html" class="text-regular">{{ $user->name }}</a>
